...
export VK_INSTANCE_LAYERS=VK_LAYER_LUNARG_api_dump,VK_LAYER_LUNARG_crash_diagnostic,VK_LAYER_LUNARG_gfxreconstruct,VK_LAYER_LUNARG_monitor,VK_LAYER_LUNARG_screenshot,VK_LAYER_KHRONOS_validation,VK_LAYER_KHRONOS_profiles,VK_LAYER_KHRONOS_shader_object,VK_LAYER_KHRONOS_synchronization2


#! LunarG API dump layer
#! ==========================================
#! VK_LAYER_LUNARG_api_dump - 1.4.350 (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
...
#! ==========================================
#! VK_LAYER_LUNARG_crash_diagnostic - 1.4.350 (BETA) (WINDOWS_X86, WINDOWS_ARM, LINUX, ANDROID)
...
export VK_LUNARG_CRASH_DIAGNOSTIC_TRACK_SEMAPHORES=false
...
#! export VK_LUNARG_CRASH_DIAGNOSTIC_TRACE_ALL_SEMAPHORES=false (Commented out as the set of dependences is not satisfied)
...
#! ==========================================
#! VK_LAYER_LUNARG_gfxreconstruct - 1.4.350 (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
...
#! ==========================================
#! VK_LAYER_LUNARG_screenshot - 1.4.350 (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
...
#! ==========================================
#! VK_LAYER_KHRONOS_validation - 1.4.350 (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
...
#! For more information about the feature: https://vulkan.lunarg.com/doc/sdk/1.4.350.0/windows/synchronization_usage.html
#! This setting has sub-settings:
...
#!  their SPIR-V
#! For more information about the feature: https://vulkan.lunarg.com/doc/sdk/1.4.350.0/windows/debug_printf.html
#! This setting has sub-settings:
...
#! Debug Descriptor
#! ------------------------------------------
#! debug_descriptor (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  [Used for VK_EXT_descriptor_buffer and VK_EXT_descriptor_heap] Enable
#!  DebugDescriptor and will print anything that uses NonSemantic.DebugDescriptor
#!  in their SPIR-V
#! This setting has sub-settings:
#! - export VK_KHRONOS_VALIDATION_DEBUG_DESCRIPTOR_TO_STDOUT=true
export VK_KHRONOS_VALIDATION_DEBUG_DESCRIPTOR=false

#! Redirect DebugDescriptor messages to stdout
#! ------------------------------------------
#! debug_descriptor_to_stdout (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Enable redirection of Debug Descriptor messages from the debug callback to
#!  stdout
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_DEBUG_DESCRIPTOR=true
#! export VK_KHRONOS_VALIDATION_DEBUG_DESCRIPTOR_TO_STDOUT=true (Commented out as the set of dependences is not satisfied)
...
#!  execution
#! For more information about the feature: https://vulkan.lunarg.com/doc/sdk/1.4.350.0/windows/gpu_validation.html
#! This setting has sub-settings:
...
#! - export VK_KHRONOS_VALIDATION_GPUAV_RAY_TRACING_BUFFERS_CONSISTENCY=false
...
#! - export VK_KHRONOS_VALIDATION_GPUAV_VALIDATE_TRACE_RAY=true
...
#! - export VK_KHRONOS_VALIDATION_GPUAV_SHARED_MEMORY_DATA_RACE=true
#! - export VK_KHRONOS_VALIDATION_GPUAV_MAX_INDICES_COUNT=8192
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
...
#! TraceRay SPIR-V instructions
#! ------------------------------------------
#! gpuav_validate_trace_ray (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Enable shader instrumentation on OpTraceRayKHR, OpHitObject*
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
#! - export VK_KHRONOS_VALIDATION_GPUAV_SHADER_INSTRUMENTATION=true
#! export VK_KHRONOS_VALIDATION_GPUAV_VALIDATE_TRACE_RAY=true (Commented out as the set of dependences is not satisfied)
...
#! ------------------------------------------
#! gpuav_shared_memory_data_race (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Detects data races on shared memory (Compute shaders only). Limitations: This
#!  does not handle mixing atomics and non-atomics on the same locations without
#!  a barrier in between, this could lead to false positives. This assumes
#!  barrier() is used for all shared memory synchronization.
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
#! - export VK_KHRONOS_VALIDATION_GPUAV_SHADER_INSTRUMENTATION=true
#! export VK_KHRONOS_VALIDATION_GPUAV_SHARED_MEMORY_DATA_RACE=true (Commented out as the set of dependences is not satisfied)

#! Maximum Indices
#! ------------------------------------------
#! gpuav_max_indices_count (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Number of indices held in the buffer used to index commands and validation
#!  resources (Max number of draws/dispatches in a command buffer that can be
#!  tracked). Can be lowered to save memory.
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
#! export VK_KHRONOS_VALIDATION_GPUAV_MAX_INDICES_COUNT=8192 (Commented out as the set of dependences is not satisfied)
...
#! ------------------------------------------
#! gpuav_ray_tracing_buffers_consistency (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Validate that between a BLAS build and its update, triangle geometries using
#!  index buffer keep its content identical (VUID 03768), and that
#!  active/inactive primitives do not change this status (VUIDs 03663 and 03664).
#!  Warning: a record of vertex/index buffers will be maintained in device local
#!  memory, so validation can be GPU memory heavy.
#! This setting requires ALL of the following values:
#! - export VK_KHRONOS_VALIDATION_GPUAV_ENABLE=true
#! - export VK_KHRONOS_VALIDATION_GPUAV_BUFFERS_VALIDATION=true
#! export VK_KHRONOS_VALIDATION_GPUAV_RAY_TRACING_BUFFERS_CONSISTENCY=false (Commented out as the set of dependences is not satisfied)
...
#! For more information about the feature: https://vulkan.lunarg.com/doc/sdk/1.4.350.0/windows/best_practices.html
#! This setting has sub-settings:
...
#! ------------------------------------------
#! gpu_dump_descriptors (ALPHA) (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Dump all the information at every draw/dispatch when recording
export VK_KHRONOS_VALIDATION_GPU_DUMP_DESCRIPTORS=false

#! Dump VK_KHR_copy_memory_indirect
#! ------------------------------------------
#! gpu_dump_copy_memory_indirect (ALPHA) (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Dump information at each copy command when recording
export VK_KHRONOS_VALIDATION_GPU_DUMP_COPY_MEMORY_INDIRECT=false

#! Dump VK_EXT_device_generated_commands
#! ------------------------------------------
#! gpu_dump_device_generated_commands (ALPHA) (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Dump information at each vkCmdExecuteGeneratedCommands when recording
export VK_KHRONOS_VALIDATION_GPU_DUMP_DEVICE_GENERATED_COMMANDS=false

#! Redirect all GPU Dump to stdout
#! ------------------------------------------
#! gpu_dump_to_stdout (ALPHA) (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  Instead of using the debug callback with information severity, redirect to
#!  stdout instead.
export VK_KHRONOS_VALIDATION_GPU_DUMP_TO_STDOUT=false

#! Force Device Copy
#! ------------------------------------------
#! gpu_dump_device_copy (ALPHA) (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
#!  [Very experimental] For non-host visible memory, try and do a device copy
#!  during command recording to view the data inside a buffer.
export VK_KHRONOS_VALIDATION_GPU_DUMP_DEVICE_COPY=false
...
#! ==========================================
#! VK_LAYER_KHRONOS_profiles - 1.4.350 (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
...
#! ==========================================
#! VK_LAYER_KHRONOS_shader_object - 1.4.350 (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS)
...
#! ==========================================
#! VK_LAYER_KHRONOS_synchronization2 - 1.4.350 (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
